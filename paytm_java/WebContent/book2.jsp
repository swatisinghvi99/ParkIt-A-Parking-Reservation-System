                ...
                <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                    <div class="card card-signin my-5">
                        <div class="card-body">
                            ...
                            <form id="form" name="form" class="form-signin" action="book3.jsp" method="post">
                                    ...
                                    <select name="location" class="custom-select form-control" required>
                                        ...
                                        <%
                                            ...
                                            try{
                                                ...
                                                PreparedStatement ps2 = conn.prepareStatement("SELECT * FROM slots where city='"+city+"' and status='Open'");
                                                ResultSet rst1 = ps2.executeQuery();
                                                while(rst1.next()){                                   
                                                
                                        %>            
                                                    <option name="location" id="location" value="<%=rst1.getString("location")%>"><%=rst1.getString("location") %></option>
                                        <%            
                                                }
