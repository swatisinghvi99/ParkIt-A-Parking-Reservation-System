      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="300">
          <div class="col-lg-3 col-md-4">
            <div class="icon-box">
              <i class="ri-user-smile-line" style="color: #ffbb2c;"></i>
          ...
          <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <h3><a href="">Foolproof</a></h3><br>

            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
            <div class="icon-box">
              <i class="ri-police-car-line" style="color: #e80368;"></i>
              <h3><a href="">Accountability</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4 mt-lg-0">
            <div class="icon-box">
              <i class="ri-hard-drive-2-line" style="color: #e361ff;"></i>
              <h3><a href="">No Clunky Hardware</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
              <i class="ri-tools-line" style="color: #47aeff;"></i>
              <h3><a href="">Customizable</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
              <i class="ri-notification-4-line" style="color: #ffa76e;"></i>
              <h3><a href="">Live Trends & Reports</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
              <i class="ri-secure-payment-line" style="color: #11dbcf;"></i>
              <h3><a href="">Safe & Secure</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
              <i class="ri-coins-line" style="color: #4233ff;"></i>
