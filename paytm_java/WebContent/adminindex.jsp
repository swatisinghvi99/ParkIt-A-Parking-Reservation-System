      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Welcome <b><%=session.getAttribute("fullName") %></b></h1>
            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
				...
				<%
                    ...
                    String sql2 ="select * from parking";
                    ...
                    ResultSet rst2 = st2.executeQuery(sql3);
                    int cust=0;
                    while(rst2.next()){
                    	cust++;
                    }
                    ...
                    String strQuery = "SELECT SUM(amount) FROM parking";
                    ResultSet rs = st1.executeQuery(strQuery);
                    double tot=0;
                    while(rs.next()){
                    	tot = rs.getFloat(1);
                    	session.setAttribute("tot",String.format("%.2f",tot));
                    }
                    connection.close();
                    } catch (Exception e) {
                    	e.printStackTrace();
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                    <div class="h5 mb-0 font-weight-bold text-gray-800"><%= session.getAttribute("loc") %></div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                    <div class="h5 mb-0 font-weight-bold text-gray-800"><%= session.getAttribute("book") %></div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                    <div class="h5 mb-0 font-weight-bold text-gray-800"><span>&#8377;</span> <%= session.getAttribute("tot") %></div>
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Annual Earning</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><%= session.getAttribute("cust") %></div>
