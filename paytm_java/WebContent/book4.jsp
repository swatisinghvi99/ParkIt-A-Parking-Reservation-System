            ...
            <div class="row">
                <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                    <div class="card card-signin my-5">
                        <div class="card-body">
                            <h5 class="card-title text-center">Tell us about your vehicle</h5>
                            <form id="form" name="form" class="form-signin" action="<%=request.getContextPath()%>/calculate" method="post">
                            
                                <div class="form-label-group">
                                    <select name="vehicleType" class="custom-select form-control" onchange="check()">
                                        ...
                                        <%
                                            ...
                                            try{
                                                ...
                                                PreparedStatement ps2 = conn.prepareStatement("SELECT * FROM vehicle_category where vehiclestatus='Active'");
                                                ResultSet rst1 = ps2.executeQuery();
                                                while(rst1.next()){                                   
                                                
                                        %>            
                                                    <option name="vehicleType" id="vehicleType" value="<%=rst1.getString("vehicleType")%>"><%=rst1.getString("vehicleType") %></option>
                                        <%            
                                                }
                                            }
                                            catch(Exception e){
                              ...
                              <div class="form-label-group">
                                    <input type="text" id="vehicleNo" class="form-control" name="vehicleNo"
                                        disabled="disabled" pattern="^[A-Z]{2}[0-9]{2}[A-Z]{2}[0-9]{4}$" placeholder="Enter License Plate Number" required autofocus>
                                    <label for="vehicleNo">Enter License Plate Number</label>
                                </div>
