                ...
                <div class="col-sm-9 col-md-7 col-lg-7 mx-auto">
                    <div class="card card-signin my-5">
                        <div class="card-body">
                            ...
                            <form class="form-signin" action="pgRedirect.jsp" method="post">
                            ...
                            <tbody>
                                ...
                                <button class="btn btn-lg btn-block text-uppercase"
                                    style="background-color: #1E4356; color: white;" type="submit">Pay<i class="fas fa-fw fa-arrow-alt-circle-right" ></i></button>
                            </form>
