    ...
    <div id="heroCarousel" class="container carousel carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          ...
          <a href="about.jsp" class="btn-get-started animate__animated animate__fadeInUp">Read More</a>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          ...
          <a href="blog.jsp" class="btn-get-started animate__animated animate__fadeInUp">Click Here</a>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          ...
          <a href="team.jsp" class="btn-get-started animate__animated animate__fadeInUp">Click here</a>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box icon-box-cyan">
              ...
              <p class="description">Barcode-based passes are instantly auto-generated for a visitor.</p>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-up">
          ...
          <div class="col-md-7 pt-4">
            ...
            <p class="font-italic" style="text-align: justify;">
              If account already exists, login directly. Else click on the signup button and make an account. Fill in all the
        ...
        <div class="row" data-aos="fade-up">
          ...
          <div class="col-md-7 pt-5 order-2 order-md-1">
            ...
            <p class="font-italic" style="text-align: justify;">
              Barcode on receipt will be scanned on arrival at the parking loft. Once scanned you will be guided to the parking lot.
            </p>
            <p style="text-align: justify;">
              While exiting you will again be required to show the receipt. Barcode will be scanned again and a message
