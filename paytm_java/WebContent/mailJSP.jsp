...
<%
    ...
    final String subject = "ParkIt Confirmation for "+ s;
    String m = (String)session.getAttribute("p_date")+ " at "+(String)session.getAttribute("p_time");		
    final String messg = "This is to confirm your booking with Park It for " + m;
