            ...
            <div class="row">
                <div class="col-sm-9 col-md-7 col-lg-7 mx-auto">
                    <div class="card card-signin my-5">
                        <div class="card-body">
                            <h5 class="card-title text-center">Parking Summary</h5>
                            <form class="form-signin" action="waitlist5.jsp" method="post">

                                <p style="margin:1px;"><b>Vehicle No: </b> <%=session.getAttribute("vehicleNo")%></p>
                                <p style="margin:1px;"><b>Order ID: </b><input id="ORDER_ID" type="hidden" name="ORDER_ID" value="ORDS_<%= randomInt %>">ORDS_<%= randomInt %></p>
                                <p style="margin:1px;"><b>Customer ID: </b><input id="CUST_ID" type="hidden" name="CUST_ID" value="CUST<%= cust %>">CUST<%= cust %></p>
                                <input id="CHANNEL_ID" type="hidden" tabindex="4" maxlength="12" size="12" name="CHANNEL_ID" value="WEB">
                                <input id="INDUSTRY_TYPE_ID" type="hidden" tabindex="4" maxlength="12" size="12" name="INDUSTRY_TYPE_ID" value="Retail">
                            ...
                            <tbody>
                                ...
                                <td></td>
                                <td><b>TOTAL</b></td>
                                <td><input title="TXN_AMOUNT" type="hidden" name="TXN_AMOUNT" value="<%=session.getAttribute("amount") %>"><%=session.getAttribute("amount") %></td>
                                </tr>
                                ...
                                <button class="btn btn-lg btn-block text-uppercase"
                                    style="background-color: #1E4356; color: white;" type="submit">Waitlist<i class="fas fa-fw fa-arrow-alt-circle-right" ></i></button>
                            </form>
