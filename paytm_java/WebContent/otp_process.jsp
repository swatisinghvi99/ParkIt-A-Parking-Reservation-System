                ...
                <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                    <div class="card card-signin my-5">
                        <div class="card-body">
                            ...
                            <form id="form" name="form" class="form-signin" action="<%= request.getContextPath() %>/register" method="post">
                                <div ><label for="otpvalue">Enter OTP:</label>
                                    <input type="text" id="otpvalue" class="form-control" name="otpvalue"
                                         required autofocus>
                                    
                                </div>
                                <br>
                                <button class="btn btn-lg btn-block text-uppercase"
                                    style="background-color: #1E4356; color: white;" type="submit">Submit</button>
                            </form>
